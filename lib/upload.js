...
exports.uploadTempFile = function(req, res) {
    ...
    uploadtempfile(req, res, function(err) {
        ...
        { excel.readExcel(req, res,req.body.userid,"./public/uploads"+req.files[0].destination.substring(16) + "/"+req.files[0].filename,req.files[0].filename, req.files[0].originalname);
